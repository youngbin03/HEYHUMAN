<template>
  ...
  />
    <div class="header">
      <div class="container">
        <ul class="nav">
          <li><router-link class="x " to="/registration"> SignUp </router-link></li>
...
/* html, body {
  ...
  .jumbotron {
    background: url(https://user-images.githubusercontent.com/87307678/201466969-d18eac67-1972-4f7b-9865-93bbebe9d165.jpg);
